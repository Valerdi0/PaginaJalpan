	...
	<body class="is-preload">
			...
			<header id="header">
				...
				<nav>
					<ul>
                        ...
                        <li><a href="/turismo/tradiciones"><strong>Tradiciones</strong></a></li>
		...
		<!-- Balneario -->
			<section id="balneariod" class="main style2 right dark fullscreen">
				<div class="content box style2" style="width: 70%;">
					<header>
					...
					<!-- Gallery  -->
						<div class="gallery">
							...
							<article class="from-left">
								<a href="{{asset('turi/images/candelaria1.jpg')}}" class="image fit"><img src="{{asset('turi/images/candelaria1.jpg')}}" title="Día de la candelaria" alt=""  width="440px" height="276px"/></a>
							</article>
							<article class="from-right">
							<a href="{{asset('turi/images/candelaria2.jpg')}}" class="image fit"><img src="{{asset('turi/images/candelaria2.jpg')}}" title="Día de la candelaria" alt=""  width="440px" height="276px"/></a>
							</article>
