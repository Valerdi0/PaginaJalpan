			...
			<!-- Nav -->
				<nav id="nav">
					<ul>
						...
						<li class="current"><a href="/organigrama">Organigrama</a></li>
						@if(Auth::check())
                            <li class="dropdown">
							...
							<div class="col-12">
								...
								<!-- Features -->
									<section class="box features">
										<h2 class="major"><span>Organigrama</span></h2>
										
										<p>Organización y Estructura de la Administración Pública Municipal		</p>
												...
												<div class="col-8 col-6-medium col-12-small">
													...
													<!-- Feature -->
														<section class="box feature">
															<a href="#" class="image featured"><img src="{{asset('images/organi.jpg')}}" alt="" /></a>
														</section>
												</div>
